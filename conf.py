...
BLOG_TITLE = "User-friendly Deep Learning: Datasets"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://datasets.cms.waikato.ac.nz/ufdl/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://datasets.cms.waikato.ac.nz/ufdl/"
BLOG_EMAIL = "fracpete@waikato.ac.nz"
BLOG_DESCRIPTION = "Datasets made available by the UFDL project."  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete output/ --exclude data fracpete@datasets.cms.waikato.ac.nz:/var/www/html/ufdl",
    ]
}
...
# If you want support for syntax $.$ the (which may conflict with running
